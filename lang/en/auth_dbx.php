...
$string['auth_dbsaltpostfix'] = 'Salt to be postfixed to password before it is hashed';
$string['auth_dbsaltpostfix_key'] = 'Postfix Salt';
$string['auth_dbsaltprefix'] = 'Salt to be prefixed to password before it is hashed';
$string['auth_dbsaltprefix_key'] = 'Prefix Salt';
