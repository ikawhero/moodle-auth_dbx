...
/**
 * Authentication Plugin: External Database Authentication Extended
 *
...
class auth_plugin_dbx extends auth_plugin_base {
    ...
    function user_login($username, $password) {
        ...
        if ($this->is_internal()) {
            ...
            // Add salt
            if ($this->config->saltprefix) {
                $extpassword = $this->config->saltprefix.$extpassword;
            }
...
/// delete obsolete internal users
    ...
    function process_config($config) {
        ...
        if (!isset($config->saltprefix)) {
            $config->saltprefix = '';
        }
        if (!isset($config->saltpostfix)) {
            $config->saltpostfix = '';
        }
